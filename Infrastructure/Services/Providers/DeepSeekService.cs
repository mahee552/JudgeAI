...
namespace ChatbotBenchmarkAPI.Infrastructure.Services.Providers
{
    ...
    public class DeepSeekService : IAIProviderService
    {
        ...
        public DeepSeekService(IConfiguration configuration, IOptions<AIEndpointsConfig> endpointsConfig, ILogger<DeepSeekService> logger, AIModelValidator modelValidator)
        {
